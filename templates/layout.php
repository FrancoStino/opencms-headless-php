...
<html lang="<?php echo $locale ?? 'en'; ?>" class="scroll-smooth">
	<head>
		...
		<title>OpenCms Headless - Demo</title>
		<link rel="icon"
			  href="data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 100 100%22><text y=%22.9em%22 font-size=%2290%22>🚀</text></svg>">
		<style>
            .svg-icon-red {
                filter: invert(27%) sepia(93%) saturate(7471%) hue-rotate(356deg) brightness(91%) contrast(115%);
            }

            /* Ridimensiona icone grandi nei contenuti */
            .prose svg,
            .prose img[src*=".svg"] {
			...
			<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
				<div class="flex flex-col md:flex-row justify-between items-center gap-4">
					...
					<div class="flex gap-4 text-sm text-gray-600 dark:text-gray-400">
						<a href="https://documentation.opencms.org/" target="_blank"
						   class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
							Documentation
						</a>
						<span>•</span>
						<a href="https://github.com/alkacon/opencms-core" target="_blank"
						   class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
							GitHub
						</a>
					</div>
